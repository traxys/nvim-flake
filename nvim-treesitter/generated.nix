...

{
  ...
  scala = buildGrammar {
    language = "scala";
    version = "0.0.0+rev=aa84398";
    src = fetchFromGitHub {
      owner = "tree-sitter";
      repo = "tree-sitter-scala";
      rev = "aa84398ad72bba17af18fa103fba6680aab78a79";
      hash = "sha256-qrovsbMVWqu6ypjf/4cYz2hGBOImSBL8G+DtAzhdROE=";
    };
  ...
  ssh_config = buildGrammar {
    language = "ssh_config";
    version = "0.0.0+rev=0842ab5";
    src = fetchFromGitHub {
      owner = "ObserverOfTime";
      repo = "tree-sitter-ssh-config";
      rev = "0842ab575dad561a0e903f309b7f871ee71c3e42";
      hash = "sha256-4L+fYDv4CkF4stOkgLqY1UVq+uUIgLuT7IgqtkY1o6E=";
    };
  ...
  t32 = buildGrammar {
    language = "t32";
    version = "0.0.0+rev=6d317c4";
    src = fetchFromGitLab {
      owner = "xasc";
      repo = "tree-sitter-t32";
      rev = "6d317c49ab310152c486ab85eb06724fd49df52d";
      hash = "sha256-GLfcha9ZBF1tcYRUQdilOQGEHzjoGQXwrs4WxC/1uBw=";
    };
  ...
  wing = buildGrammar {
    language = "wing";
    version = "0.0.0+rev=0316314";
    src = fetchFromGitHub {
      owner = "winglang";
      repo = "wing";
      rev = "0316314246f6fbdfe614e6dc7e29d4b9b9ce1ca8";
      hash = "sha256-kto/9422XCDXI49YcdaDgNf/1MyCk1oTl0KwruCG8aE=";
    };
